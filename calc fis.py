...
print('''Este programa está em desenvolvimento e constantemente terá atualizações,
com a adição de novas fórmulas e opções. Enfim, vamos lá!''')
...
Força = f
Energia cinética = c
Energia potencial gravitacional: g
Trabalho = tr
Potência = p
Função horária (final) = sf
Função horária (inicial) = so
Lei dos cossenos = co
Conversão celsius - fahrenheit = tc
Conversão fahrenheit - celsius = tf
Conversão celsiu - fahrenheit - celsius (variação) = vc
Dilatação linear = d''')
